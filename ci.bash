...
MVN_ALL="${MVN_CLEAN_CMD} ${MVN_CLEAN_PARAM} ${MVN_UPDATE_CMD} ${MVN_DOC_CMD} ${MVN_DOC_PARAM} ${MVN_SOURCE_CMD} ${MVN_GPG_CMD} ${MVN_GPG_PARAM} versions:display-dependency-updates versions:display-plugin-updates"
echo "[DEBUG] [${MVN_ALL}]"
mvn ${MVN_ALL}