...
public class ReadmeBuilderTest {
    ...
    public void runBuilder() throws IOException {
        ...
        assertThat(input, containsString("*autogenerated please use the builder file to for changing the [include]: # (test.include.md)*"));
        ...
        assertThat(result, containsString("*autogenerated please use the builder file to for changing the content*"));
